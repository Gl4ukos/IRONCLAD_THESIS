...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/maria/ironclad_ws/src/control)
  set(control_DEVEL_PREFIX /home/maria/ironclad_ws/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/maria/ironclad_ws/install)
...
if(NOT "/home/maria/ironclad_ws/src/control/include;/usr/include/eigen3 " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/maria/ironclad_ws/src/control/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maria/ironclad_ws/src/control/${idir}'.  ${_report}")
    endif()
    _list_append_unique(control_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "control_lib")
